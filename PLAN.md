...
7. **Важно**: Добавить автотесты для всех функций (API, друзья, шаринг, массовое удаление)
8. **В последнюю очередь**: Восстановить данные из Redis к аккаунту пользователя (после того как всё заработает) - пока используем существующие данные
