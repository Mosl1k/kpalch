...
### Этап 8: Автотесты ⏳
- [ ] Настроить pytest для Django проекта
- [ ] Добавить тесты для API endpoints (CRUD операции со списками)
- [ ] Добавить тесты для функций друзей (добавление, принятие, отклонение запросов)
- [ ] Добавить тесты для шаринга списков
- [ ] Добавить тесты для массового удаления
- [ ] Добавить тесты для внутренних API (для telegram-bot и alice)
- [ ] Настроить CI/CD для запуска тестов при коммитах
